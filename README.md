...
I am not a software engineer. I design these systems, build them with Claude
Code, and run them across almost every aspect of my professional and personal
life.
...
use, including the regression check that re-scores the ranking against six
confirmed customers at the start of every session. Client identities have been
removed from the commentary; the logic is unmodified, and where a docstring was
rewritten the file says so at the top.
